...
Decay_b = Decay(name = 'Decay_b',
                particle = P.b,
                partial_widths = {(P.S1,P.vm__tilde__):'((MB**2 - MS1**2)*(3*gL32**2*MB**2 - 3*gL32**2*MS1**2))/(96.*cmath.pi*abs(MB)**3)',
                                  (P.S1,P.vt__tilde__):'((MB**2 - MS1**2)*(3*gL3**2*MB**2 - 3*gL3**2*MS1**2))/(96.*cmath.pi*abs(MB)**3)',
                                  (P.U1,P.ta__minus__):'((3*hL33**2*MB**2 + 3*hL33**2*MTA**2 + (3*hL33**2*MB**4)/MU1**2 - (6*hL33**2*MB**2*MTA**2)/MU1**2 + (3*hL33**2*MTA**4)/MU1**2 - 6*hL33**2*MU1**2)*cmath.sqrt(MB**4 - 2*MB**2*MTA**2 + MTA**4 - 2*MB**2*MU1**2 - 2*MTA**2*MU1**2 + MU1**4))/(96.*cmath.pi*abs(MB)**3)',
...
Decay_S1 = Decay(name = 'Decay_S1',
                 particle = P.S1,
                 partial_widths = {(P.mu__minus__,P.t):'((MS1**2 - MT**2)*(3*gL32**2*MS1**2 - 3*gL32**2*MT**2))/(48.*cmath.pi*abs(MS1)**3)',
                                   (P.ta__minus__,P.c):'((MS1**2 - MTA**2)*(3*gR23**2*MS1**2 - 3*gR23**2*MTA**2))/(48.*cmath.pi*abs(MS1)**3)',
                                   (P.ta__minus__,P.t):'((3*gL3**2*MS1**2 - 3*gL3**2*MT**2 - 3*gL3**2*MTA**2)*cmath.sqrt(MS1**4 - 2*MS1**2*MT**2 + MT**4 - 2*MS1**2*MTA**2 - 2*MT**2*MTA**2 + MTA**4))/(48.*cmath.pi*abs(MS1)**3)',
                                   (P.vm,P.b):'((-MB**2 + MS1**2)*(-3*gL32**2*MB**2 + 3*gL32**2*MS1**2))/(48.*cmath.pi*abs(MS1)**3)',
                                   (P.vt,P.b):'((-MB**2 + MS1**2)*(-3*gL3**2*MB**2 + 3*gL3**2*MS1**2))/(48.*cmath.pi*abs(MS1)**3)'})

Decay_t = Decay(name = 'Decay_t',
                particle = P.t,
                partial_widths = {(P.S1,P.mu__plus__):'((-MS1**2 + MT**2)*(-3*gL32**2*MS1**2 + 3*gL32**2*MT**2))/(96.*cmath.pi*abs(MT)**3)',
                                  (P.S1,P.ta__plus__):'((-3*gL3**2*MS1**2 + 3*gL3**2*MT**2 + 3*gL3**2*MTA**2)*cmath.sqrt(MS1**4 - 2*MS1**2*MT**2 + MT**4 - 2*MS1**2*MTA**2 - 2*MT**2*MTA**2 + MTA**4))/(96.*cmath.pi*abs(MT)**3)',
                                  (P.U1,P.vt):'((MT**2 - MU1**2)*(3*hL33**2*MT**2 + (3*hL33**2*MT**4)/MU1**2 - 6*hL33**2*MU1**2))/(96.*cmath.pi*abs(MT)**3)',
...
Decay_ta__minus__ = Decay(name = 'Decay_ta__minus__',
                          ...
                          partial_widths = {(P.S1,P.c__tilde__):'((-MS1**2 + MTA**2)*(-3*gR23**2*MS1**2 + 3*gR23**2*MTA**2))/(32.*cmath.pi*abs(MTA)**3)',
                                            (P.S1,P.t__tilde__):'((-3*gL3**2*MS1**2 + 3*gL3**2*MT**2 + 3*gL3**2*MTA**2)*cmath.sqrt(MS1**4 - 2*MS1**2*MT**2 + MT**4 - 2*MS1**2*MTA**2 - 2*MT**2*MTA**2 + MTA**4))/(32.*cmath.pi*abs(MTA)**3)',
                                            (P.U1__tilde__,P.b):'((3*hL33**2*MB**2 + 3*hL33**2*MTA**2 + (3*hL33**2*MB**4)/MU1**2 - (6*hL33**2*MB**2*MTA**2)/MU1**2 + (3*hL33**2*MTA**4)/MU1**2 - 6*hL33**2*MU1**2)*cmath.sqrt(MB**4 - 2*MB**2*MTA**2 + MTA**4 - 2*MB**2*MU1**2 - 2*MTA**2*MU1**2 + MU1**4))/(32.*cmath.pi*abs(MTA)**3)',
                                            (P.U1__tilde__,P.s):'((MTA**2 - MU1**2)*(3*hL2**2*MTA**2 + (3*hL2**2*MTA**4)/MU1**2 - 6*hL2**2*MU1**2))/(32.*cmath.pi*abs(MTA)**3)',
                                            (P.W__minus__,P.vt):'((MTA**2 - MW**2)*((ee**2*MTA**2)/(2.*sw**2) + (ee**2*MTA**4)/(2.*MW**2*sw**2) - (ee**2*MW**2)/sw**2))/(32.*cmath.pi*abs(MTA)**3)'})

Decay_U1 = Decay(name = 'Decay_U1',
                 particle = P.U1,
                 partial_widths = {(P.b,P.ta__plus__):'((-3*hL33**2*MB**2 - 3*hL33**2*MTA**2 - (3*hL33**2*MB**4)/MU1**2 + (6*hL33**2*MB**2*MTA**2)/MU1**2 - (3*hL33**2*MTA**4)/MU1**2 + 6*hL33**2*MU1**2)*cmath.sqrt(MB**4 - 2*MB**2*MTA**2 + MTA**4 - 2*MB**2*MU1**2 - 2*MTA**2*MU1**2 + MU1**4))/(144.*cmath.pi*abs(MU1)**3)',
                                   (P.c,P.vt__tilde__):'(hL2**2*MU1**4)/(24.*cmath.pi*abs(MU1)**3)',
                                   (P.s,P.ta__plus__):'((-MTA**2 + MU1**2)*(-3*hL2**2*MTA**2 - (3*hL2**2*MTA**4)/MU1**2 + 6*hL2**2*MU1**2))/(144.*cmath.pi*abs(MU1)**3)',
                                   (P.t,P.vt__tilde__):'((-MT**2 + MU1**2)*(-3*hL33**2*MT**2 - (3*hL33**2*MT**4)/MU1**2 + 6*hL33**2*MU1**2))/(144.*cmath.pi*abs(MU1)**3)'})
