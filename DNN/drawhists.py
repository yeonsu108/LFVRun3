...
if year=="run2":
    ...
    s.addChannel(year+"/ST_LFV_TCMuTau_Scalar_"+year+syst+"_pred.root", "LFV STc s", 10, isMC=True, xsec=rlumi[year]*7.40, counterhistogramroot=year+"/ST_LFV_TCMuTau_Scalar_"+year+syst+"_pred.root")
    s.addChannel(year+"/ST_LFV_TCMuTau_Vector_"+year+syst+"_pred.root", "LFV STc v", 10, isMC=True, xsec=rlumi[year]*36.8, counterhistogramroot=year+"/ST_LFV_TCMuTau_Vector_"+year+syst+"_pred.root")
    s.addChannel(year+"/ST_LFV_TCMuTau_Tensor_"+year+syst+"_pred.root", "LFV STc t", 10, isMC=True, xsec=rlumi[year]*178.4, counterhistogramroot=year+"/ST_LFV_TCMuTau_Tensor_"+year+syst+"_pred.root")
    s.addChannel(year+"/ST_LFV_TUMuTau_Scalar_"+year+syst+"_pred.root", "LFV STu s", 11, isMC=True, xsec=rlumi[year]*83.8, counterhistogramroot=year+"/ST_LFV_TUMuTau_Scalar_"+year+syst+"_pred.root")
    s.addChannel(year+"/ST_LFV_TUMuTau_Vector_"+year+syst+"_pred.root", "LFV STu v", 11, isMC=True, xsec=rlumi[year]*393, counterhistogramroot=year+"/ST_LFV_TUMuTau_Vector_"+year+syst+"_pred.root")
    s.addChannel(year+"/ST_LFV_TUMuTau_Tensor_"+year+syst+"_pred.root", "LFV STu t", 11, isMC=True, xsec=rlumi[year]*1796, counterhistogramroot=year+"/ST_LFV_TUMuTau_Tensor_"+year+syst+"_pred.root")
    s.addChannel(year+"/TT_LFV_TToCMuTau_Scalar_"+year+syst+"_pred.root", "LFV TTc s", 12, isMC=True, xsec=rlumi[year]*2.69, counterhistogramroot=year+"/TT_LFV_TToCMuTau_Scalar_"+year+syst+"_pred.root")
    s.addChannel(year+"/TT_LFV_TToCMuTau_Vector_"+year+syst+"_pred.root", "LFV TTc v", 12, isMC=True, xsec=rlumi[year]*21.5, counterhistogramroot=year+"/TT_LFV_TToCMuTau_Vector_"+year+syst+"_pred.root")
    s.addChannel(year+"/TT_LFV_TToCMuTau_Tensor_"+year+syst+"_pred.root", "LFV TTc t", 12, isMC=True, xsec=rlumi[year]*129.0, counterhistogramroot=year+"/TT_LFV_TToCMuTau_Tensor_"+year+syst+"_pred.root")
    s.addChannel(year+"/TT_LFV_TToUMuTau_Scalar_"+year+syst+"_pred.root", "LFV TTu s", 13, isMC=True, xsec=rlumi[year]*2.69, counterhistogramroot=year+"/TT_LFV_TToUMuTau_Scalar_"+year+syst+"_pred.root")
    s.addChannel(year+"/TT_LFV_TToUMuTau_Vector_"+year+syst+"_pred.root", "LFV TTu v", 13, isMC=True, xsec=rlumi[year]*21.5, counterhistogramroot=year+"/TT_LFV_TToUMuTau_Vector_"+year+syst+"_pred.root")
    s.addChannel(year+"/TT_LFV_TToUMuTau_Tensor_"+year+syst+"_pred.root", "LFV TTu t", 13, isMC=True, xsec=rlumi[year]*129.0, counterhistogramroot=year+"/TT_LFV_TToUMuTau_Tensor_"+year+syst+"_pred.root")
for run in runs:
