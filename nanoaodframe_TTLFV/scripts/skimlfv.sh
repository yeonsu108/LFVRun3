...
./skimnanoaod.py -F --split ${njobs} -Y skim16pre ${mcdir}/TT_LFV_TToCMuTau_Scalar_TuneCP5_13TeV-madgraph-pythia8  ${tgdir}/TT_LFV_TToCMuTau_Scalar > ${log}/TT_LFV_TToCMuTau_Scalar_skim16pre.out
...
#./skimnanoaod.py -F --split ${njobs} -Y skim17 ${mcdir}/ST_LFV_TUMuTau_Scalar_TuneCP5_13TeV-madgraph-pythia8    ${tgdir}/ST_LFV_TUMuTau_Scalar > ${log}/ST_LFV_TUMuTau_Scalar_skim17.out
#./skimnanoaod.py -F --split ${njobs} -Y skim17 ${mcdir}/ST_LFV_TUMuTau_Vector_TuneCP5_13TeV-madgraph-pythia8    ${tgdir}/ST_LFV_TUMuTau_Vector > ${log}/ST_LFV_TUMuTau_Vector_skim17.out
...
#./skimnanoaod.py -F --split ${njobs} -Y skim18 ${mcdir}/ST_LFV_TCMuTau_Tensor_TuneCP5_13TeV-madgraph-pythia8    ${tgdir}/ST_LFV_TCMuTau_Tensor > ${log}/ST_LFV_TCMuTau_Tensor_skim18.out
...
#./skimnanoaod.py -F --split ${njobs} -Y skim18 ${mcdir}/ST_LFV_TUMuTau_Tensor_TuneCP5_13TeV-madgraph-pythia8    ${tgdir}/ST_LFV_TUMuTau_Tensor > ${log}/ST_LFV_TUMuTau_Tensor_skim18.out
...
#./skimnanoaod.py -F --split ${njobs} -Y skim18 ${mcdir}/TT_LFV_TToCMuTau_Tensor_TuneCP5_13TeV-madgraph-pythia8  ${tgdir}/TT_LFV_TToCMuTau_Tensor > ${log}/TT_LFV_TToCMuTau_Tensor_skim18.out
