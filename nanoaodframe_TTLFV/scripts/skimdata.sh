...
./skimnanoaod.py -F --split ${njobs} -Y skim16pre  ${datadir}/Run2016C ${tgdir}/SingleMuon2016C &> ${log}/SingleMuon2016C_skim.out
./skimnanoaod.py -F --split ${njobs} -Y skim16pre  ${datadir}/Run2016D ${tgdir}/SingleMuon2016D &> ${log}/SingleMuon2016D_skim.out
./skimnanoaod.py -F --split ${njobs} -Y skim16pre  ${datadir}/Run2016E ${tgdir}/SingleMuon2016E &> ${log}/SingleMuon2016E_skim.out
...
./skimnanoaod.py -F --split ${njobs} -Y skim16post ${datadir}/Run2016G ${tgdir}/SingleMuon2016G &> ${log}/SingleMuon2016G_skim.out
./skimnanoaod.py -F --split ${njobs} -Y skim16post ${datadir}/Run2016H ${tgdir}/SingleMuon2016H &> ${log}/SingleMuon2016H_skim.out
./skimnanoaod.py -F --split ${njobs} -Y skim17     ${datadir}/Run2017B ${tgdir}/SingleMuon2017B &> ${log}/SingleMuon2017B_skim.out
./skimnanoaod.py -F --split ${njobs} -Y skim17     ${datadir}/Run2017C ${tgdir}/SingleMuon2017C &> ${log}/SingleMuon2017C_skim.out
./skimnanoaod.py -F --split ${njobs} -Y skim17     ${datadir}/Run2017D ${tgdir}/SingleMuon2017D &> ${log}/SingleMuon2017D_skim.out
./skimnanoaod.py -F --split ${njobs} -Y skim17     ${datadir}/Run2017E ${tgdir}/SingleMuon2017E &> ${log}/SingleMuon2017E_skim.out
./skimnanoaod.py -F --split ${njobs} -Y skim17     ${datadir}/Run2017F ${tgdir}/SingleMuon2017F &> ${log}/SingleMuon2017F_skim.out
