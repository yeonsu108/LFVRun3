...
void LQtopAnalyzer::defineCuts()
{
	...
	// check for good json event is defined earlier
        ...
        addCuts("Sys_METpt > 10 && Sys_METpt < 70","00000");
}
/*
template <typename T>
...
void LQtopAnalyzer::defineMoreVars()
{
	// define your higher level variables here
        ...
        addVar({"Sel2_jet4btag","Sel2_jetbtag[3]",""});
        ...
        addVar({"chi2_lfvTop_mass","top_reco_whad[1]",""});
        ...
        addVar({"chi2_lfvTop","top_reco_whad[7]",""});
        addVar({"chi2_SMW","top_reco_whad[8]",""});
        addVar({"chi2_SMTop","top_reco_whad[9]",""});
...
//        add1DHist( {"h1npvsgood", "Number of good PVs", 100, 0.0, 100.0}, "PV_npvsGood", "evWeight_pglep", "0");
	...
	add1DHist( {"h1ncleanjetspass", "Passing jetcuts", 10, 0.0, 10.0}, "ncleanjetspass", "evWeight_pglep", "0");
        ...
        add1DHist( {"h1jet1pt", "leading jet pt", 20, 0, 400}, "Sel2_jet1pt", "evWeight_pglep", "000");
        add1DHist( {"h1jet1eta", "leading jet eta", 18, -2.7, 2.7}, "Sel2_jet1eta", "evWeight_pglep", "000");
        add1DHist( {"h1jet1mass", "leading jet mass", 20, 0, 100}, "Sel2_jet1mass", "evWeight_pglep", "000");
        add1DHist( {"h1jet2pt", "sub-leading jet pt", 20, 0, 400}, "Sel2_jet2pt", "evWeight_pglep", "000");
        add1DHist( {"h1jet2eta", "sub-leading jet eta", 18, -2.7, 2.7}, "Sel2_jet2eta", "evWeight_pglep", "000");
        add1DHist( {"h1jet2mass", "sub-leading jet mass", 20, 0, 100}, "Sel2_jet2mass", "evWeight_pglep", "000");
        add1DHist( {"h1jet3pt", "third jet pt", 20, 0, 400}, "Sel2_jet3pt", "evWeight_pglep", "000");
        add1DHist( {"h1jet3eta", "third jet eta", 18, -2.7, 2.7}, "Sel2_jet3eta", "evWeight_pglep", "000");
        add1DHist( {"h1jet3mass", "third jet mass", 20, 0, 100}, "Sel2_jet3mass", "evWeight_pglep", "000");
        add1DHist( {"h1jet4pt", "fourth jet pt", 20, 0, 400}, "Sel2_jet4pt", "evWeight_pglep", "000");
        add1DHist( {"h1jet4eta", "fourth jet eta", 18, -2.7, 2.7}, "Sel2_jet4eta", "evWeight_pglep", "000");
        add1DHist( {"h1jet4mass", "fourth jet mass", 20, 0, 100}, "Sel2_jet4mass", "evWeight_pglep", "000");
        add1DHist( {"h1bjet1pt", "b jet pt", 20, 0, 400}, "Sel2_bjet1pt", "evWeight_pglep", "000");
        add1DHist( {"h1bjet1eta", "b jet eta", 18, -2.7, 2.7}, "Sel2_bjet1eta", "evWeight_pglep", "000");
        add1DHist( {"h1bjet1mass", "b jet mass", 20, 0, 100}, "Sel2_bjet1mass", "evWeight_pglep", "000");

        add1DHist( {"h1jet1btag","btag discr of leading jet", 20, 0, 1.0}, "Sel2_jet1btag", "evWeight_pglep", "000");
        add1DHist( {"h1jet2btag","btag discr of sub-leading jet", 20, 0, 1.0}, "Sel2_jet2btag", "evWeight_pglep", "000");
        add1DHist( {"h1jet3btag","btag discr of third jet", 20, 0, 1.0}, "Sel2_jet3btag", "evWeight_pglep", "000");
        add1DHist( {"h1jet4btag","btag discr of fourth jet", 20, 0, 1.0}, "Sel2_jet4btag", "evWeight_pglep", "000");

        //=================== Fully weighted ===================
	add1DHist( {"hmetpt", "MET pt", 20, 0, 400}, "Sys_METpt", "evWeight", "0000");
	add1DHist( {"hsumet", "Sum ET", 50, 0.0, 5000.0}, "MET_sumEt", "evWeight", "0000");
	add1DHist( {"hmetphi", "MET phi", 20, -4.0, 4.0}, "Sys_METphi", "evWeight", "0000");

	add1DHist( {"hnmuonpass", "Passing muoncuts", 5, 0.0, 5.0}, "nmuonpass", "evWeight", "0000");
	add1DHist( {"hncleantaupass", "Passing taucuts", 5, 0.0, 5.0}, "ncleantaupass", "evWeight", "0000");
	add1DHist( {"hncleanjetspass", "Passing jetcuts", 10, 0.0, 10.0}, "ncleanjetspass", "evWeight", "0000");
        add1DHist( {"hncleanbjetspass", "Passing bjetcuts", 5, 0.0, 5.0}, "ncleanbjetspass", "evWeight", "0000");

        add1DHist( {"hmuon1pt", "Muon pt", 20, 0, 400}, "Sel_muon1pt", "evWeight", "0000");
        add1DHist( {"hmuon1eta", "Muon eta", 18, -2.7, 2.7}, "Sel_muon1eta", "evWeight", "0000");
        add1DHist( {"hmuon1mass", "Muon mass", 20, 0, 100}, "Sel_muon1mass", "evWeight", "0000");
    
        add1DHist( {"htau1pt", "Tau pt", 20, 0, 400}, "Sel_tau1pt", "evWeight", "0000");
        add1DHist( {"htau1eta", "Tau eta", 18, -2.7, 2.7}, "Sel_tau1eta", "evWeight", "0000");
        add1DHist( {"htau1mass", "Tau mass", 20, 0, 100}, "Sel_tau1mass", "evWeight", "0000");
        ...
        add1DHist( {"hmutau_mass", "Mass of muon and tau", 30, 0, 600}, "mutau_mass", "evWeight","0000");
        
        add1DHist( {"hjet1pt", "leading jet pt", 20, 0, 400}, "Sel2_jet1pt", "evWeight", "0000");
        add1DHist( {"hjet1eta", "leading jet eta", 18, -2.7, 2.7}, "Sel2_jet1eta", "evWeight", "0000");
        add1DHist( {"hjet1mass", "leading jet mass", 20, 0, 100}, "Sel2_jet1mass", "evWeight", "0000");
        add1DHist( {"hjet2pt", "sub-leading jet pt", 20, 0, 400}, "Sel2_jet2pt", "evWeight", "0000");
        add1DHist( {"hjet2eta", "sub-leading jet eta", 18, -2.7, 2.7}, "Sel2_jet2eta", "evWeight", "0000");
        add1DHist( {"hjet2mass", "sub-leading jet mass", 20, 0, 100}, "Sel2_jet2mass", "evWeight", "0000");
        add1DHist( {"hjet3pt", "third jet pt", 20, 0, 400}, "Sel2_jet3pt", "evWeight", "0000");
        add1DHist( {"hjet3eta", "third jet eta", 18, -2.7, 2.7}, "Sel2_jet3eta", "evWeight", "0000");
        add1DHist( {"hjet3mass", "third jet mass", 20, 0, 100}, "Sel2_jet3mass", "evWeight", "0000");
        add1DHist( {"hjet4pt", "fourth jet pt", 20, 0, 400}, "Sel2_jet4pt", "evWeight", "0000");
        add1DHist( {"hjet4eta", "fourth jet eta", 18, -2.7, 2.7}, "Sel2_jet4eta", "evWeight", "0000");
        add1DHist( {"hjet4mass", "fourth jet mass", 20, 0, 100}, "Sel2_jet4mass", "evWeight", "0000");
        add1DHist( {"hbjet1pt", "b jet pt", 20, 0, 400}, "Sel2_bjet1pt", "evWeight", "0000");
        add1DHist( {"hbjet1eta", "b jet eta", 18, -2.7, 2.7}, "Sel2_bjet1eta", "evWeight", "0000");
        add1DHist( {"hbjet1mass", "b jet mass", 20, 0, 100}, "Sel2_bjet1mass", "evWeight", "0000");

        add1DHist( {"hjet1btag","btag discr of leading jet", 20, 0, 1.0}, "Sel2_jet1btag", "evWeight", "0000");
        add1DHist( {"hjet2btag","btag discr of sub-leading jet", 20, 0, 1.0}, "Sel2_jet2btag", "evWeight", "0000");
        add1DHist( {"hjet3btag","btag discr of third jet", 20, 0, 1.0}, "Sel2_jet3btag", "evWeight", "0000");
        add1DHist( {"hjet4btag","btag discr of fourth jet", 20, 0, 1.0}, "Sel2_jet4btag", "evWeight", "0000");
        ...
        add1DHist( {"hchi2_lfvTop_mass", "chi2 LFV Top mass", 20, 0, 400}, "chi2_lfvTop_mass", "evWeight","0000");
        ...
        add1DHist( {"hchi2_lfvjmu_absdEta", "abs dEta of lfv jet and muon", 15, 0, 3.0}, "chi2_lfvjmu_absdEta", "evWeight","0000");
        ...
        add1DHist( {"hchi2_lfvjmu_dR", "dR of lfv jet and muon", 20, 0, 4.0}, "chi2_lfvjmu_dR", "evWeight","0000");
        add1DHist( {"hchi2_lfvjmu_mass", "Mass of lfv jet and muon", 15, 0, 300}, "chi2_lfvjmu_mass", "evWeight","0000");
        
        add1DHist( {"hchi2_lfvjtau_dEta", "dEta of lfv jet and tau", 25, -5, 5}, "chi2_lfvjtau_dEta", "evWeight","0000");
        add1DHist( {"hchi2_lfvjtau_absdEta", "abs dEta of lfv jet and tau", 15, 0, 3.0}, "chi2_lfvjtau_absdEta", "evWeight","0000");
        ...
        add1DHist( {"hchi2_lfvjtau_dR", "dR of lfv jet and tau", 20, 0, 4.0}, "chi2_lfvjtau_dR", "evWeight","0000");
        add1DHist( {"hchi2_lfvjtau_mass", "Mass of lfv jet and tau", 15, 0, 300}, "chi2_lfvjtau_mass", "evWeight","0000"); 
        
        add1DHist( {"hchi2_lfvjmutau_dEta", "dEta of lfv jet and mutau", 25, -5, 5}, "chi2_lfvjmutau_dEta", "evWeight","0000");
        add1DHist( {"hchi2_lfvjmutau_absdEta", "abs dEta of lfv jet and mutau", 15, 0, 3.0}, "chi2_lfvjmutau_absdEta", "evWeight","0000");
        ...
        add1DHist( {"hchi2_lfvjmutau_dR", "dR of lfv jet and mutau", 20, 0, 4.0}, "chi2_lfvjmutau_dR", "evWeight","0000");
}
