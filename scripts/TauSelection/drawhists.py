...
s.addHistogram("htau1pt", "p_{T} of Tau (GeV)", "Entries", drawmode=stackhists.STACKED, drawoption="hist", isLogy=logstyle, ymin=0.1)
s.addHistogram("htau1eta", "#eta of Tau", "Entries", drawmode=stackhists.STACKED, drawoption="hist", isLogy=logstyle, ymin=0.1)
