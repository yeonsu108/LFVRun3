...
//  h1->Draw("E");
  ...
  c->Print(Form("may_LFV/%s_%s.pdf",name.Data(),kind.Data()));
...
void plot(){
  ...
  TFile * f = new TFile("may_LFV/SM_ttbar.root");

  TFile * f11 = new TFile("may_LFV/LFV_ST_TCMuTau_Scalar.root");
  TFile * f12 = new TFile("may_LFV/LFV_ST_TUMuTau_Scalar.root");
  TFile * f13 = new TFile("may_LFV/LFV_TT_TToCMuTau_Scalar.root");
  TFile * f14 = new TFile("may_LFV/LFV_TT_TToUMuTau_Scalar.root");

  TFile * f21 = new TFile("may_LFV/LFV_ST_TCMuTau_Vector.root");
  TFile * f22 = new TFile("may_LFV/LFV_ST_TUMuTau_Vector.root");
  TFile * f23 = new TFile("may_LFV/LFV_TT_TToCMuTau_Vector.root");
  TFile * f24 = new TFile("may_LFV/LFV_TT_TToUMuTau_Vector.root");

  TFile * f31 = new TFile("may_LFV/LFV_ST_TCMuTau_Tensor.root");
  TFile * f32 = new TFile("may_LFV/LFV_ST_TUMuTau_Tensor.root");
  TFile * f33 = new TFile("may_LFV/LFV_TT_TToCMuTau_Tensor.root");
  TFile * f34 = new TFile("may_LFV/LFV_TT_TToUMuTau_Tensor.root");

  make5LFVfilePlot(f,f11,f12,f13,f14,"Scalar","h_bpt","Normalized Entries","p_{T}_{b}", 0.70, 0.65, 0.85, 0.9);
  make5LFVfilePlot(f,f11,f12,f13,f14,"Scalar","h_mupt","Normalized Entries","p_{T}_{#mu}", 0.70, 0.65, 0.85, 0.9);
  make5LFVfilePlot(f,f11,f12,f13,f14,"Scalar","h_taupt","Normalized Entries","p_{T}_{#tau}", 0.70, 0.65, 0.85, 0.9);
  make5LFVfilePlot(f,f11,f12,f13,f14,"Scalar","h_beta","Normalized Entries","|#eta|_{b}", 0.70, 0.65, 0.85, 0.9);
  make5LFVfilePlot(f,f11,f12,f13,f14,"Scalar","h_mueta","Normalized Entries","|#eta|_{#mu}", 0.70, 0.65, 0.85, 0.9);
  make5LFVfilePlot(f,f11,f12,f13,f14,"Scalar","h_taueta","Normalized Entries","|#eta|_{#tau}", 0.70, 0.65, 0.85, 0.9); 
  make5LFVfilePlot(f,f11,f12,f13,f14,"Scalar","h_lepdR","Normalized Entries","#Delta R(#mu,#tau)", 0.70, 0.65, 0.85, 0.9);
  make5LFVfilePlot(f,f11,f12,f13,f14,"Scalar","h_lepmass","Normalized Entries","M(#mu,#tau)", 0.70, 0.65, 0.85, 0.9);
  make5LFVfilePlot(f,f21,f22,f23,f24,"Vector","h_bpt","Normalized Entries","p_{T}_{b}", 0.70, 0.65, 0.85, 0.9);
  make5LFVfilePlot(f,f21,f22,f23,f24,"Vector","h_mupt","Normalized Entries","p_{T}_{#mu}", 0.70, 0.65, 0.85, 0.9);
  make5LFVfilePlot(f,f21,f22,f23,f24,"Vector","h_taupt","Normalized Entries","p_{T}_{#tau}", 0.70, 0.65, 0.85, 0.9);
  make5LFVfilePlot(f,f21,f22,f23,f24,"Vector","h_beta","Normalized Entries","|#eta|_{b}", 0.70, 0.65, 0.85, 0.9);
  make5LFVfilePlot(f,f21,f22,f23,f24,"Vector","h_mueta","Normalized Entries","|#eta|_{#mu}", 0.70, 0.65, 0.85, 0.9);
  make5LFVfilePlot(f,f21,f22,f23,f24,"Vector","h_taueta","Normalized Entries","|#eta|_{#tau}", 0.70, 0.65, 0.85, 0.9); 
  make5LFVfilePlot(f,f21,f22,f23,f24,"Vector","h_lepdR","Normalized Entries","#Delta R(#mu,#tau)", 0.70, 0.65, 0.85, 0.9);
  make5LFVfilePlot(f,f21,f22,f23,f24,"Vector","h_lepmass","Normalized Entries","M(#mu,#tau)", 0.70, 0.65, 0.85, 0.9);
  make5LFVfilePlot(f,f31,f32,f33,f34,"Tensor","h_bpt","Normalized Entries","p_{T}_{b}", 0.70, 0.65, 0.85, 0.9);
  make5LFVfilePlot(f,f31,f32,f33,f34,"Tensor","h_mupt","Normalized Entries","p_{T}_{#mu}", 0.70, 0.65, 0.85, 0.9);
  make5LFVfilePlot(f,f31,f32,f33,f34,"Tensor","h_taupt","Normalized Entries","p_{T}_{#tau}", 0.70, 0.65, 0.85, 0.9);
  make5LFVfilePlot(f,f31,f32,f33,f34,"Tensor","h_beta","Normalized Entries","|#eta|_{b}", 0.70, 0.65, 0.85, 0.9);
  make5LFVfilePlot(f,f31,f32,f33,f34,"Tensor","h_mueta","Normalized Entries","|#eta|_{#mu}", 0.70, 0.65, 0.85, 0.9);
  make5LFVfilePlot(f,f31,f32,f33,f34,"Tensor","h_taueta","Normalized Entries","|#eta|_{#tau}", 0.70, 0.65, 0.85, 0.9); 
  make5LFVfilePlot(f,f31,f32,f33,f34,"Tensor","h_lepdR","Normalized Entries","#Delta R(#mu,#tau)", 0.70, 0.65, 0.85, 0.9);
  make5LFVfilePlot(f,f31,f32,f33,f34,"Tensor","h_lepmass","Normalized Entries","M(#mu,#tau)", 0.70, 0.65, 0.85, 0.9);
  
  make3LFVfilePlot(f11,f21,f31,"h_lepdR","LFV_ST_TCMuTau","Normalized Entries","#Delta R(#mu,#tau)", 0.70, 0.65, 0.85, 0.9);
  make3LFVfilePlot(f11,f21,f31,"h_lepmass","LFV_ST_TCMuTau","Normalized Entries","M(#mu,#tau)", 0.70, 0.65, 0.85, 0.9);
  make3LFVfilePlot(f11,f21,f31,"h_bpt","LFV_ST_TCMuTau","Normalized Entries","p_{T}_{b}", 0.70, 0.65, 0.85, 0.9);
  make3LFVfilePlot(f11,f21,f31,"h_mupt","LFV_ST_TCMuTau","Normalized Entries","p_{T}_{#mu}", 0.70, 0.65, 0.85, 0.9);
  make3LFVfilePlot(f11,f21,f31,"h_taupt","LFV_ST_TCMuTau","Normalized Entries","p_{T}_{#tau}", 0.70, 0.65, 0.85, 0.9);
  make3LFVfilePlot(f11,f21,f31,"h_beta","LFV_ST_TCMuTau","Normalized Entries","|#eta|_{b}", 0.70, 0.65, 0.85, 0.9);
  make3LFVfilePlot(f11,f21,f31,"h_mueta","LFV_ST_TCMuTau","Normalized Entries","|#eta|_{#mu}", 0.70, 0.65, 0.85, 0.9);
  
  make3LFVfilePlot(f12,f22,f32,"h_lepdR","LFV_ST_TUMuTau","Normalized Entries","#Delta R(#mu,#tau)", 0.70, 0.65, 0.85, 0.9);
  make3LFVfilePlot(f12,f22,f32,"h_lepmass","LFV_ST_TUMuTau","Normalized Entries","M(#mu,#tau)", 0.70, 0.65, 0.85, 0.9);
  make3LFVfilePlot(f12,f22,f32,"h_bpt","LFV_ST_TUMuTau","Normalized Entries","p_{T}_{b}", 0.70, 0.65, 0.85, 0.9);
  make3LFVfilePlot(f12,f22,f32,"h_mupt","LFV_ST_TUMuTau","Normalized Entries","p_{T}_{#mu}", 0.70, 0.65, 0.85, 0.9);
  make3LFVfilePlot(f12,f22,f32,"h_taupt","LFV_ST_TUMuTau","Normalized Entries","p_{T}_{#tau}", 0.70, 0.65, 0.85, 0.9);
  make3LFVfilePlot(f12,f22,f32,"h_beta","LFV_ST_TUMuTau","Normalized Entries","|#eta|_{b}", 0.70, 0.65, 0.85, 0.9);
  make3LFVfilePlot(f12,f22,f32,"h_mueta","LFV_ST_TUMuTau","Normalized Entries","|#eta|_{#mu}", 0.70, 0.65, 0.85, 0.9);
  
  make3LFVfilePlot(f13,f23,f33,"h_lepdR","LFV_TT_TCMuTau","Normalized Entries","#Delta R(#mu,#tau)", 0.70, 0.65, 0.85, 0.9);
  make3LFVfilePlot(f13,f23,f33,"h_lepmass","LFV_TT_TCMuTau","Normalized Entries","M(#mu,#tau)", 0.70, 0.65, 0.85, 0.9);
  make3LFVfilePlot(f13,f23,f33,"h_bpt","LFV_TT_TCMuTau","Normalized Entries","p_{T}_{b}", 0.70, 0.65, 0.85, 0.9);
  make3LFVfilePlot(f13,f23,f33,"h_mupt","LFV_TT_TCMuTau","Normalized Entries","p_{T}_{#mu}", 0.70, 0.65, 0.85, 0.9);
  make3LFVfilePlot(f13,f23,f33,"h_taupt","LFV_TT_TCMuTau","Normalized Entries","p_{T}_{#tau}", 0.70, 0.65, 0.85, 0.9);
  make3LFVfilePlot(f13,f23,f33,"h_beta","LFV_TT_TCMuTau","Normalized Entries","|#eta|_{b}", 0.70, 0.65, 0.85, 0.9);
  make3LFVfilePlot(f13,f23,f33,"h_mueta","LFV_TT_TCMuTau","Normalized Entries","|#eta|_{#mu}", 0.70, 0.65, 0.85, 0.9);
  
  make3LFVfilePlot(f14,f24,f34,"h_lepdR","LFV_TT_TUMuTau","Normalized Entries","#Delta R(#mu,#tau)", 0.70, 0.65, 0.85, 0.9);
  make3LFVfilePlot(f14,f24,f34,"h_lepmass","LFV_TT_TUMuTau","Normalized Entries","M(#mu,#tau)", 0.70, 0.65, 0.85, 0.9);
  make3LFVfilePlot(f14,f24,f34,"h_bpt","LFV_TT_TUMuTau","Normalized Entries","p_{T}_{b}", 0.70, 0.65, 0.85, 0.9);
  make3LFVfilePlot(f14,f24,f34,"h_mupt","LFV_TT_TUMuTau","Normalized Entries","p_{T}_{#mu}", 0.70, 0.65, 0.85, 0.9);
  make3LFVfilePlot(f14,f24,f34,"h_taupt","LFV_TT_TUMuTau","Normalized Entries","p_{T}_{#tau}", 0.70, 0.65, 0.85, 0.9);
  make3LFVfilePlot(f14,f24,f34,"h_beta","LFV_TT_TUMuTau","Normalized Entries","|#eta|_{b}", 0.70, 0.65, 0.85, 0.9);
  make3LFVfilePlot(f14,f24,f34,"h_mueta","LFV_TT_TUMuTau","Normalized Entries","|#eta|_{#mu}", 0.70, 0.65, 0.85, 0.9);
  /* 
