...
void make7filePlot(TFile * f1, TFile * f2,TFile * f3,TFile * f4,TFile * f5, TFile * f6, TFile * f7, TString name, TString ytitle, TString xtitle, float x1, float y1, float x2, float y2){
  ...
  c->Print(Form("genana_noLQ/%s.pdf",name.Data()));
...
//  TFile * f1 = new TFile("older/LFV_TT_to_cmutau_Ceu_2018_GenAna_v2.root");
//  TFile * f2 = new TFile("older/LFV_TT_to_cmutau_Clequ1_2018_GenAna_v2.root");
//  TFile * f3 = new TFile("older/LFV_TT_to_cmutau_Clequ3_2018_GenAna_v2.root");
//  TFile * f4 = new TFile("older/LFV_TT_to_cmutau_Clq_2018_GenAna_v2.root");
//  TFile * f5 = new TFile("older/LFV_TT_to_cmutau_Clu_2018_GenAna_v2.root");
//  TFile * f6 = new TFile("older/LFV_TT_to_cmutau_Cqe_2018_GenAna_v2.root");
//  TFile * f7 = new TFile("older/SM_TTToDiLeptonic_2018_GenAna_v2.root");

  TFile * f1 = new TFile("older/LFV_TT_to_cmutau_Clq_2018_GenAna_v1.root");
  TFile * f2 = new TFile("older/LFV_TT_to_cmutau_Clu_2018_GenAna_v1.root");
  TFile * f3 = new TFile("older/LFV_TT_to_cmutau_Cqe_2018_GenAna_v1.root");
  TFile * f4 = new TFile("older/LFV_TT_to_cmutau_Ceu_2018_GenAna_v1.root");
  TFile * f5 = new TFile("older/LFV_TT_to_cmutau_Clequ1_2018_GenAna_v1.root");
  TFile * f6 = new TFile("older/LFV_TT_to_cmutau_Clequ3_2018_GenAna_v1.root");
  TFile * f7 = new TFile("may_LFV/SM_TTbar_dileptonic_V1.root");
