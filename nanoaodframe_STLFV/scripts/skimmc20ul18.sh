...
#./skimnanoaod.py -F --split ${njobs} -Y skim18 ${mcdir20ul18}/QCD_Pt-300To470_MuEnrichedPt5_TuneCP5_13TeV-pythia8 ${tgdir18}/QCD_Pt-300To470_MuEnrichedPt5 &> ${logdir}/QCD_Pt-300To470_MuEnrichedPt5_skim18.out
