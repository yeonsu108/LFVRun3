/*
 * TopSTlfvAnalyzer.cpp
 *
 *  Created on: April 9, 2020
 *      Author: Tae Jeong Kim
 */

#include "TopSTlfvAnalyzer.h"
#include "utility.h"

TopSTlfvAnalyzer::TopSTlfvAnalyzer(TTree *t, std::string outfilename, std::string year, std::string syst, std::string jsonfname, string globaltag, int nthreads)
...
void TopSTlfvAnalyzer::defineCuts()
{
...
/*
template <typename T>
void TopSTlfvAnalyzer::defineVar(std::string varname, T function,  const RDFDetail::ColumnNames_t &columns)
{
	NanoAODAnalyzerrdframe::defineVar(varname, function, columns);
}
*/

void TopSTlfvAnalyzer::defineMoreVars()
{
...
void TopSTlfvAnalyzer::bookHists()
{
